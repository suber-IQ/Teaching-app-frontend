...
const Databox = ({ title, gty, gtyPercentage, profit }) => (
  <Box
    w={['full', '20%']}
  ...
  >
    <Text children={title} />
    <HStack spacing={'6'}>
      <Text fontSize={'2xl'} fontWeight="bold" children={gty} />
      <HStack>
        <Text children={`${gtyPercentage}%`} />
        {profit ? (
    ...
    >
      {loading || !stats ? (
        ...
        <Box boxSizing="border-box" py={'16'} px={['4', '0']}>
          ...
          >
            <Databox title="Views" gty={viewsCount} gtyPercentage={viewsPercentage} profit={viewsProfit} />
            <Databox title="Users" gty={usersCount} gtyPercentage={usersPercentage} profit={usersProfit} />
            <Databox
              title="Subscription"
              gty={subscriptionsCount}
              gtyPercentage={subscriptionsPercentage}
